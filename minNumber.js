 ...
 // notes - program returns unexpectd values something about arrays numbers and strings....how they are stored. 
 
  // Write code here that returns the smallest value in numbers
  // loop through array and compare it to a variable starting at zero
  // if the number is less than the number stored in the variable replace it
  // run the program for the whole array
  // return variable
  //
